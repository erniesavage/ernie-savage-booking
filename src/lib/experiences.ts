...
export const experienceData: Record<string, ExperienceInfo> = {
  'secret-ballads': {
    ...
    cardDesc:
      'An after-hours songwriter salon featuring classic ballads, forgotten gems, and personal stories — performed up close, without spectacle, the way these songs were meant to be heard.',
    fullDesc: [
